  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        ...
        <nav style={{ flex: 1 }}>
          {[{ name: 'Inicio', slug: '/' }, { name: 'Amigos', slug: '/followers' }, { name: 'Comunidades', slug: '/communits' }].map((menuItem) => (
...
AlurakutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: rgba(10, 6, 41, 0.68);
  ...
  .container {
    ...
    nav {
      ...
      a {
        ...
        &:after {
          content: " ";
          background-color: rgba(212, 106, 93, 0.68);
          display: block;
          position: absolute;
          width: 1px;
          height: 12px;
